...
Source2:        macros.ostree.kmodtool
...
mkdir -p %{buildroot}%{_sysconfdir}/pki/%{name}/certs \
         ...
         %{buildroot}%{_sysconfdir}/rpm/macros
...
install -pm 0640 %{SOURCE2} %{buildroot}%{_sysconfdir}/rpm/macros/
...
%attr(0644,root,root) %{_sysconfdir}/rpm/macros

%changelog
* Mon June 28 2022 Christian Mainka <Christian.Mainka@rub.de> - 0.0.2
- Used macros.ostree.kmodtool to avoid filename conflicts
